CREATE TABLE `tasks` (
                         ...
                         `atomic_task` tinyint(1) NOT NULL DEFAULT 0,
                         `is_dynamic` tinyint(1) NOT NULL DEFAULT 0,
                         `is_schedule_block` tinyint(1) NOT NULL DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=1329 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci